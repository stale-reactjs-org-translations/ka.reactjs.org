...
- [არააუცილებელი: სცადეთ React-ის გამოყენება JSX-თან ერთად](#optional-try-react-with-jsx) (bundler-ის საჭიროების გარეშე!)

## დაამატეთ React ერთ წუთში {#add-react-in-one-minute}

ამ განყოფილებაში ისწავლით როგორ ხდება არსებულ HTML-გვერდზე React-კომპონენტის დამატება. მოცემული ინსტრუქცია შეგიძლიათ გამოსცადოთ თქვენს ვებსაიტზე ან დემონსტრირებისათვის შექმნათ ცარიელი HTML-ფაილი.

რთული ინსტრუმენტების გამოყენება ან რაიმეს დაყენება არ იქნება საჭირო: **ყველაფერი, რაც ამ განყოფილებაში მოცემული მითითებების შესასრულებლად დაგჭირდებათ, არის კავშირი ინტერნეტთან და თქვენი ძვირფასი დროიდან ერთი წუთის გამოყოფა.**
...
**[საწყისი კოდის](https://gist.github.com/gaearon/0b180827c190fe4fd98b4c7f570ea4a8/raw/b9157ce933c79a4559d2aa9ff3372668cce48de7/LikeButton.js)** შემდეგ, `like_button.js` ფაილის ბოლოში (ქვემოთ), დაამატეთ კიდევ ორი ხაზი:
...
## არააუცილებელი: სცადეთ React-ის გამოყენება JSX-თან ერთად {#optional-try-react-with-jsx}
...
გილოცავთ! ახლახან თქვენს პროექტს დაამატეთ **JSX-ის მხარდაჭერა, რომელიც მზად არის წარმოებაში ჩასაშვებად**.
...
თუ ფიქრობთ, რომ თავისუფლად ფლობთ განხილულ ხელსაწყოებს და გინდათ მათგან მეტი სარგებელი მიიღოთ, [შემდეგ განყოფილებაში](/docs/create-a-new-react-app.html) განვიხილავთ რამდენიმე ყველაზე პოპულარულ ხელსაწყოთა ნაკრებს. თუ ასე არ ფიქრობთ, არ იდარდოთ, ზემოთ განხილული `script`-ტეგებიც საკმარისად გამოსადეგია!
