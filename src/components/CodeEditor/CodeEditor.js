    ...
    if (showBabelErrorMessage) {
      errorMessage = (
        <span>
          ...
          <br />
          <br />
          შესაძლოა, ეს რეკლამების მბლოკავმა გამოიწვია. თუ თქვენ ასეთს იყენებთ,
          განიხილეთ reactjs.org-ის დამატება თეთრ სიაში, რათა კოდის მაგალითების
          მყისიერი ჩვენება მოხერხდეს.
        </span>
      );
    } else if (error != null) {
